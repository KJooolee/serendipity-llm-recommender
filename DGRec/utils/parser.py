...
def parse_args():
    ...
    parser.add_argument('--epoch', default = 1000, type = int,
                        help = 'epoch number')
    parser.add_argument('--patience', default = 100, type = int,   ## 자원쓰기용으로 일단 100으로 늘림
    ...
    parser.add_argument('--k_list', default = [5,10], type = list,
    ...
    parser.add_argument('--metrics', default = ['recall', 'hit_ratio', 'coverage','ndcg','mrr'])
